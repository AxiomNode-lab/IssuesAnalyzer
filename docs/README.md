...
This directory is the source of truth for GitHub Opportunity Radar.
...
All estimates and scores shown to users must be explainable and must never be presented as guarantees.
